...
export default function Landing() {
  ...
  const scrollToKelas = (e: React.MouseEvent) => {
    e.preventDefault();
  ...
  return (
    <div className="min-h-screen bg-[var(--color-landing-bg)] font-sans text-[var(--color-landing-black)] overflow-clip selection:bg-[var(--color-landing-cyan)]">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="hidden md:flex items-center gap-6 font-barlow font-bold text-lg mr-4">
              <Link
                to="/"
                className="hover:text-[var(--color-landing-cyan)] transition-colors"
              >
                Beranda
              </Link>
              <a
        ...
        <div className="bg-[var(--color-landing-hero)] border-[3px] border-[var(--color-landing-black)] shadow-[8px_8px_0_#111111] p-6 md:p-12 lg:p-16 flex flex-col lg:flex-row items-center gap-8 md:gap-12">
          <div className="flex-1 space-y-6">
            ...
            <p className="font-barlow font-medium text-xl sm:text-2xl text-gray-800 max-w-2xl">
              Belajar lewat cerita, tulis kodenya langsung di browser, dan
              bangun proyek nyata dari nol.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              {isSupabaseConfigured ? (
                ...
                <a
                  href="#kelas"
                  onClick={scrollToKelas}
                  className="bg-[var(--color-landing-cyan)] border-[3px] border-[var(--color-landing-black)] px-6 py-4 font-bungee text-lg shadow-[4px_4px_0_#111111] hover:shadow-[2px_2px_0_#111111] hover:translate-x-[2px] hover:translate-y-[2px] transition-all text-center inline-block"
                >
                  MULAI BELAJAR
                </a>
              )}
              <a
                href="#kelas"
                onClick={scrollToKelas}
                className="bg-[var(--color-landing-black)] text-white border-[3px] border-[var(--color-landing-black)] px-6 py-4 font-bungee text-lg shadow-[4px_4px_0_var(--color-landing-cyan)] hover:shadow-[2px_2px_0_var(--color-landing-cyan)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all text-center inline-block"
              >
                LIHAT KELAS
              </a>
            </div>
      ...
      <section className="px-4 py-16 sm:px-8 max-w-7xl mx-auto">
        <h2 className="font-bungee text-3xl sm:text-4xl mb-12">
          <span
            ...
            style={{
              backgroundImage:
                'linear-gradient(transparent 60%, var(--color-landing-purple) 60%)',
            }}
          >
            MENGAPA BISANGODING?
          </span>
        ...
        <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-8">
          <div
            className="bg-[var(--color-landing-card)] border-[3px] border-[var(--color-landing-black)] shadow-[8px_8px_0_#111111] p-6 flex flex-col gap-4"
            style={{
              clipPath:
          ...
          >
            <div className="flex items-center gap-3">
              <BookOpen
                className="w-8 h-8 text-[var(--color-landing-purple)]"
                strokeWidth={2}
              />
              <h3 className="font-bungee text-xl mt-1">MATERI BERCERITA</h3>
            </div>
            <p className="font-barlow text-[19px] font-medium text-gray-800">
              Setiap konsep dijelaskan lewat cerita dan kasus nyata, bukan
              hafalan definisi.
            </p>
          </div>
          <div
          ...
          >
            ...
            <p className="font-barlow text-[19px] font-medium text-gray-800">
              Tulis dan jalankan kode langsung di browser, tanpa install apa pun.
              Latihan dinilai otomatis.
            </p>
          </div>
          <div
            className="bg-[var(--color-landing-card)] border-[3px] border-[var(--color-landing-black)] shadow-[8px_8px_0_#111111] p-6 flex flex-col gap-4"
          ...
          >
            ...
            <p className="font-barlow text-[19px] font-medium text-gray-800">
              Bangun aplikasi Todolist dan sistem perpustakaan dari nol, langkah
              demi langkah.
            </p>
          </div>
          <ComingSoon>
            <div
              className="bg-[var(--color-landing-card)] border-[3px] border-[var(--color-landing-black)] shadow-[8px_8px_0_#111111] p-6 flex flex-col gap-4 h-full"
              style={{
                clipPath:
                  'polygon(0 0, calc(100% - 24px) 0, 100% 24px, 100% 100%, 0 100%)',
              }}
            >
              <div className="flex items-center gap-3">
                ...
                <h3 className="font-bungee text-xl mt-1 text-gray-500">
                  MENTOR & KOMUNITAS
                </h3>
              </div>
              <p className="font-barlow text-[19px] font-medium text-gray-500">
                Diskusi dan tanya jawab bersama sesama pelajar.
              </p>
            </div>
          </ComingSoon>
        </div>
      ...
      <section id="kelas" className="px-4 py-16 sm:px-8 max-w-7xl mx-auto">
        <h2 className="font-bungee text-3xl sm:text-4xl mb-12">
          <span
            ...
            style={{
              backgroundImage:
                'linear-gradient(transparent 60%, var(--color-landing-cyan) 60%)',
            }}
          >
            KELAS TERSEDIA
          </span>
        ...
        <div className="bg-[var(--color-landing-cyan)] border-[3px] border-[var(--color-landing-black)] shadow-[8px_8px_0_#111111] p-6 sm:p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {coursesData.sort((a, b) => a.order - b.order).map((course) => {
              ...
              const soonModulesCount = courseModules.length - readyModules.length;
              
              const allLessons = readyModules.flatMap(m => getVisibleLessons(m.id));
              const totalMinutes = allLessons.reduce((acc, l) => acc + (l.estimatedMinutes || 5), 0);
              const totalHours = Math.round(totalMinutes / 60);

              const isCourseReady = course.status !== 'soon';

              if (!isCourseReady) {
                return (
                  <ComingSoon key={course.id}>
                    <div className="bg-gray-200 border-[3px] border-[var(--color-landing-black)] shadow-[4px_4px_0_#111111] h-full flex flex-col opacity-75">
                      <div className="h-40 bg-gray-300 border-b-[3px] border-[var(--color-landing-black)] flex items-center justify-center relative">
                        <Lock className="w-16 h-16 text-gray-500" />
                        <div className="absolute top-4 left-4 bg-[var(--color-landing-black)] text-white px-3 py-1 font-bungee text-sm">
                          {course.language.toUpperCase()}
                        </div>
                      </div>
                      <div className="p-6 flex-1 flex flex-col justify-between gap-4">
                        <div>
                          <h3 className="font-bungee text-2xl leading-tight mb-3 text-gray-600">
                            {course.title}
                          </h3>
                          <p className="font-barlow font-medium text-gray-600 text-lg mb-4">
                            {course.description}
                          </p>
                        ...
                        <button
                          disabled
                          className="w-full bg-gray-400 text-white border-[3px] border-[var(--color-landing-black)] py-3 font-bungee text-base"
                        >
                          BELUM TERSEDIA
                        </button>
                      </div>
              ...
              return (
                <div
                  key={course.id}
                  className="bg-[var(--color-landing-card)] border-[3px] border-[var(--color-landing-black)] shadow-[4px_4px_0_#111111] h-full flex flex-col bg-white hover:-translate-y-1 hover:shadow-[6px_6px_0_#111111] transition-all"
                >
                  <div className="h-40 bg-[var(--color-landing-hero)] border-b-[3px] border-[var(--color-landing-black)] flex items-center justify-center p-6 relative">
                    <div className="absolute top-4 left-4 bg-[var(--color-landing-black)] text-white px-3 py-1 font-bungee text-sm shadow-[2px_2px_0_var(--color-landing-cyan)]">
                      {course.language.toUpperCase()}
                    </div>
                    <span className="font-bungee text-5xl text-white drop-shadow-[3px_3px_0_#111]">
                      {course.language.toUpperCase()}
                    </span>
                  </div>
                  <div className="p-6 flex-1 flex flex-col justify-between gap-4">
                    <div>
                      <h3 className="font-bungee text-2xl leading-tight mb-3">
                        {course.title}
                      </h3>
                      <p className="font-barlow font-medium text-gray-800 text-lg mb-4">
                        {course.description}
                      </p>
                      <div className="flex flex-col gap-1 font-barlow font-bold text-gray-600 text-sm">
                        <p>{readyModules.length} modul · {allLessons.length} materi · ~{totalHours} jam</p>
                        {soonModulesCount > 0 && (
                          <p className="text-[var(--color-landing-purple)]">+{soonModulesCount} modul segera hadir</p>
                        )}
                      </div>
                    </div>
                    {isSupabaseConfigured ? (
                      ...
                      <Link
                        to={`/kelas/${course.id}`}
                        className="w-full bg-[var(--color-landing-black)] text-white border-[3px] border-[var(--color-landing-black)] py-3 font-bungee text-base shadow-[4px_4px_0_var(--color-landing-cyan)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0_var(--color-landing-cyan)] transition-all text-center inline-block mt-4"
                      >
                        MULAI BELAJAR
                      </Link>
                    )}
      ...
      <section
        id="cara-belajar"
        className="px-4 py-16 sm:px-8 max-w-7xl mx-auto relative"
      >
        <h2 className="font-bungee text-3xl sm:text-4xl mb-12">
          <span
            className="inline"
            style={{
              backgroundImage:
                'linear-gradient(transparent 60%, var(--color-landing-magenta) 60%)',
            }}
          >
            CARA BELAJAR
          </span>
          ...
          {[
            {
              ...
              desc: 'Sekali klik, progresmu langsung tersimpan.',
            },
            {
              title: 'Baca ceritanya',
              desc: 'Setiap pelajaran dimulai dari masalah nyata.',
            },
            {
              title: 'Tulis kodenya',
              desc: 'Jalankan, lihat hasilnya, dan selesaikan tantangannya.',
            },
          ].map((item, i) => (
      ...
      <section className="px-4 py-16 sm:px-8 max-w-7xl mx-auto bg-[var(--color-landing-magenta)] border-y-[6px] border-[var(--color-landing-black)]">
        <h2
          className="font-bungee text-3xl sm:text-4xl text-white mb-12"
        ...
        <div className="max-w-md mx-auto">
          <ComingSoon>
            <div className="bg-[var(--color-landing-card)] border-[3px] border-[var(--color-landing-black)] shadow-[8px_8px_0_#111111] p-8 relative">
              <h3 className="font-bungee text-xl mb-3 text-gray-500">
                Jadilah yang pertama berbagi cerita belajarmu di BisaNgoding
              </h3>
              <p className="font-barlow font-bold text-gray-400 mt-4 text-sm">
                SEGERA HADIR
              </p>
              {/* Speech bubble tail */}
              <div className="absolute -bottom-[20px] left-8 w-0 h-0 border-l-[20px] border-l-transparent border-t-[20px] border-t-[var(--color-landing-black)] border-r-[20px] border-r-transparent"></div>
        ...
        <div className="text-center mb-12">
          <h2 className="font-bungee text-3xl sm:text-4xl">
            <span
              ...
              style={{
                backgroundImage:
                  'linear-gradient(transparent 60%, var(--color-landing-hero) 60%)',
              }}
            >
              FAQ
            </span>
        ...
        <div className="space-y-6">
          {[
            { q: 'Apakah gratis?', a: 'Ya, seluruh materi saat ini gratis.' },
            {
              ...
              a: 'Tidak. Kode dijalankan langsung di browser.',
            },
            {
              q: 'Bisa belajar di HP?',
              a: 'Bisa. Progres tersimpan dan tersinkron antara HP dan laptop.',
            },
            {
              q: 'Kenapa harus login?',
              a: 'Agar progres belajarmu tersimpan dan bisa dilanjutkan di perangkat lain.',
            },
          ].map((faq, i) => (
            <details
              key={i}
              className="bg-[var(--color-landing-card)] border-[3px] border-[var(--color-landing-black)] shadow-[4px_4px_0_#111111] group [&_summary::-webkit-details-marker]:hidden"
            >
        ...
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          {isSupabaseConfigured ? (
            ...
            <a
              href="#kelas"
              onClick={scrollToKelas}
              className="w-full md:w-auto bg-white text-[var(--color-landing-black)] border-[3px] border-[var(--color-landing-black)] px-8 py-5 font-bungee text-xl shadow-[6px_6px_0_#111111] hover:shadow-[2px_2px_0_#111111] hover:translate-x-[4px] hover:translate-y-[4px] transition-all whitespace-nowrap inline-block text-center"
            >
              MULAI BELAJAR
            </a>
          )}
      ...
      <footer className="bg-[var(--color-landing-black)] text-white px-4 py-12 sm:px-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center md:items-start gap-8 border-b border-gray-800 pb-8 mb-8">
          ...
          <div className="flex flex-wrap justify-center md:justify-end gap-x-8 gap-y-4 font-barlow font-bold text-lg">
            ...
            <a
              href="#"
              className="hover:text-[var(--color-landing-cyan)] transition-colors cursor-not-allowed opacity-50"
