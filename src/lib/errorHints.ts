export const ERROR_HINTS: Record<string, string> = {
  "';' expected":
    'Ada perintah yang belum diakhiri titik koma. Cek baris yang ditunjuk atau baris sebelumnya.',
  'cannot find symbol':
    'Java tidak mengenal nama itu. Cek salah ketik, huruf besar-kecil, atau apakah variabelnya sudah dibuat.',
  'incompatible types':
    'Tipe data tidak cocok, misalnya mengisi teks ke variabel int.',
  'missing return statement':
    'Method yang punya tipe kembalian belum mengembalikan nilai di semua kemungkinan.',
  'class, interface, enum, or record expected':
    'Ada kurung kurawal yang kelebihan atau kurang.',
  'reached end of file while parsing':
    'Ada kurung kurawal { yang belum ditutup.',
  ...
  ArrayIndexOutOfBoundsException:
    'Mengakses index array di luar batas. Ingat, index terakhir adalah panjang dikurangi 1.',
  NullPointerException:
    'Memakai object yang masih null (belum dibuat dengan new atau belum diisi).',
  ...
  StackOverflowError:
    'Method rekursif tidak pernah berhenti. Cek base case-nya.',
  ClassCastException:
    'Casting object ke tipe yang bukan tipe aslinya. Cek dengan instanceof dulu.',
};
